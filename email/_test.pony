...
class \nodoc\ iso _TestHeaders is UnitTest
  ...
  fun apply(h: TestHelper)? =>
    ...
    h.assert_eq[String](headers(0)?, "To: notreallyred@example.com, red@example.com")
    h.assert_eq[String](headers(1)?, "Cc: notreallyred@example.com, red@example.com")
    h.assert_eq[String](headers(2)?, "Subject: This is a random subject")
    h.assert_eq[String](headers(3)?.substring(0,46), "Content-Type: multipart/alternative; boundary=")
    h.assert_eq[String](headers(4)?, "")
